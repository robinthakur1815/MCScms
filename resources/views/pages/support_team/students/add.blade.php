            ...
            <form id="ajax-reg" method="post" enctype="multipart/form-data" class="wizard-form steps-validation" action="{{ route('students.store') }}" data-fouc>
               @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input value="{{ old('father_name') }}" required type="text" placeholder="Father_name" class="form-control">
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input value="{{ old('mother_name') }}" class="form-control" placeholder="Mother_name" type="text" required>
                            </div>
                        </div>
                    </div>
                ...
                <fieldset>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <label for="dorm_id">Catagery: </label>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Cast:</label>
                                <input type="text" name="dorm_room_no" placeholder="Cast" class="form-control" value="{{ old('dorm_room_no') }}">
                            </div>
                        </div>
