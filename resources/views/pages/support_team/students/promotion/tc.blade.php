...
<div class="container">
            ...
            <tr>
                ...
                <td>
                    ...
                    <br/> <br/>
                     ...
                     <span style="color: #000; font-weight: bold; font-size: 25px;"> TRANSFAR CERTIFICATE </span>
                </td>
            </tr>
        </table>
    ...
    <div class="bold arial" style="text-align: center; float:right; width: 200px; padding: 5px; margin-right:30px">
        <div style="padding: 10px 20px; width: 200px; background-color: lightcyan;">
            <span  style="font-size: 16px;">Reference No.</span>
        </div>
       ...
       <div style="float: left; margin-left: 20px">
           <table style="font-size: 16px" class="td-left" cellspacing="5" cellpadding="5">
               ...
               <tr>
                   ...
                   <td class="bold">Resion:</td>
                <!-- <td>{{ $sr->my_class->name }}</td> -->
            </tr>
            <tr>
                <td class="bold">Behaviour:</td>
                <!-- <td>{{ $sr->my_class->name }}</td> -->
                <td class="bold">Date of addmission:</td>
                <!-- <td>{{ $sr->my_class->name }}</td> -->
            </tr>
            <tr>
            ...
            <tr>
                <td class="bold">Catagrey / Cast:</td>
                <!-- <td>{{ $sr->my_class->name }}</td> -->
        ...
        <!-- {{-- Payment Info --}} -->
        <!-- <div style="margin-top:5px; display: block; background-color: rgba(92, 172, 237, 0.12); padding: 5px; ">
            <span style="font-weight:bold; font-size: 20px; color: #000; padding-left: 10px">TRANSFAR CERTIFICATE </span>
        </div> -->
        ...
        <div class="bold arial" style="text-align: center; float:right; width: 200px; padding: 5px; margin-right:30px">
            ...
            <div  style="padding: 10px 20px; width: 200px; background-color: lightyellow;">
                <span  style="font-size: 25px;">prinipale singh </span>
            </div>
        </div>
        <div class="clear"></div>
    </div>
