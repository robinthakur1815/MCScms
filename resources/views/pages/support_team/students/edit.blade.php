                ...
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <select required data-placeholder="Select State First" class="select-search form-control" name="City" id="City">
                                @if($sr->user->lga_id)
                ...
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label> Cast:</label>
                                <input type="text" name="dorm_room_no" placeholder="Cast" class="form-control" value="{{ $sr->dorm_room_no }}">
                            </div>
                        </div>
                    </div>
                </fieldset>
